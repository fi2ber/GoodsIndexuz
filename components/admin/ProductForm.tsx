  ...
  const {
    ...
    defaultValues: product
      ? {
          ...
          certificates_ru: (Array.isArray(product.certificates_ru) ? product.certificates_ru : []) as any,
          certificates_en: (Array.isArray(product.certificates_en) ? product.certificates_en : []) as any,
          seasonality: (Array.isArray(product.seasonality) ? product.seasonality : []) as number[],
          ...
          faqs_ru: (Array.isArray(product.faqs_ru) ? product.faqs_ru : []) as any,
          faqs_en: (Array.isArray(product.faqs_en) ? product.faqs_en : []) as any,
        }
      : {
          is_active: true,
          is_featured: false,
