...
async function runMigration011() {
  try {
    console.log("🚀 Выполнение миграции 011_add_is_featured.sql...\n");
    const migrationSQL = readFileSync(
      join(process.cwd(), "supabase/migrations/011_add_is_featured.sql"),
      "utf-8"
    );
    ...
    console.log("\n✅ Миграция 011_add_is_featured.sql выполнена успешно!");
